...
<head>
	<meta charset="UTF-8">
	<title>Enrolled Experts in Arts</title>
</head>
<style>
	body{
...
<body>
    ...
    <button onclick="window.location.href='more4.php'" style="float:right;right:7px;">EXPLORE MORE</button>
	...
	<div class="content">
		<table align="left" border="0px" style="width:600px;">
