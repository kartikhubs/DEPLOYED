<?php 
   ...
   $select=mysqli_query($con1,"SELECT * from others");
?>
...
<head>
	<meta charset="UTF-8">
	<title>More Expert details in Other careers</title>
</head>
<style>
	body{
...
<body>
    ...
    <p style="left:50px;position:absolute;top:60px;font-size:25px;">Email them and get connected through MAVEN</p>
