<?php 
   ...
   $select=mysqli_query($con1,"SELECT * from commerce");
?>
...
<head>
	<meta charset="UTF-8">
	<title>More Expert details in commerce career</title>
</head>
<style>
	body{
...
<body>
    ...
    <button onclick="window.location.href='StudThank.html'" style="float:right;right:7px;">FINISH</button>
    <p style="left:520px;position:absolute;top:60px;font-size:25px;">Email them and get connected through MAVEN</p>
